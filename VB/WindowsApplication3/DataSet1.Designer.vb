...
Namespace DXSample
	...
	Partial Public Class DataSet1
		...
		Partial Public Class CustomerInfoDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCustomerInfoRow(ByVal CustomerID As Integer, ByVal FirstName As String, ByVal LastName As String, ByVal [Date] As System.DateTime, ByVal Check As Boolean) As CustomerInfoRow
				Dim rowCustomerInfoRow As CustomerInfoRow = (CType(Me.NewRow(), CustomerInfoRow))
				Dim columnValuesArray() As Object = { CustomerID, FirstName, LastName, [Date], Check}
