...
Namespace DXSample
    ...
    Partial Public Class DataSet1
        ...
        Partial Public Class CustomerInfoDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Function AddCustomerInfoRow(ByVal CustomerID As Integer, ByVal FirstName As String, ByVal LastName As String, ByVal [Date] As Date, ByVal Check As Boolean) As CustomerInfoRow
