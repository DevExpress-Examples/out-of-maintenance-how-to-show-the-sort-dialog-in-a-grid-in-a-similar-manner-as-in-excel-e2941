...
Namespace DXSample
	Partial Public Class SortForm
		...
		Private Sub SortForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			SetUpRepositories()
			PopulateTree()
		End Sub
		...
		Public Sub SaveChanges()
			...
			For Each node As TreeListNode In sortTree.Nodes
				...
				If column Is Nothing Then
					Continue For
				End If
				Dim sortMode As ColumnSortMode = CType(node("SortOn"), ColumnSortMode)
				Dim sortOrder As ColumnSortOrder = CType(node("SortOrder"), ColumnSortOrder)
