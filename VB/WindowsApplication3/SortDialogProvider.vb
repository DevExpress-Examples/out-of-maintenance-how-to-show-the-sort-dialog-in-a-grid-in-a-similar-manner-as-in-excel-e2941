...
'INSTANT VB NOTE: The field showSortIndexInColumnHeader was renamed since Visual Basic does not allow fields to have the same name as other class members:
		 ...
		 Private Sub OnPopupMenuShowing(ByVal sender As Object, ByVal e As PopupMenuShowingEventArgs)
			 ...
			 If menu Is Nothing Then
				 Return
			 End If
			 menu.Items.Add(New DXMenuItem("Show Sort Dialog", AddressOf OnItemClick, My.Resources.SortDialog))
		 End Sub
