...
'ORIGINAL LINE: this.simpleButton6.Click += new System.EventHandler(this.OnMoveDown);
			' 
			' simpleButton5
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.simpleButton5.Click += new System.EventHandler(this.OnMoveUp);
			' 
			' deleteLevelButton
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.deleteLevelButton.Click += new System.EventHandler(this.OnDeleteLevel);
			' 
			' imageCollection
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.addLevelButton.Click += new System.EventHandler(this.OnAddLevel);
			' 
			' sortTree
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.repositoryItemComboBox1.EditValueChanged += new System.EventHandler(this.OnColumnChanged);
			' 
			' treeListColumn2
			' 
			...
			Me.Text = "SortForm"
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.Load += new System.EventHandler(this.SortForm_Load);
